...
import (
	...
	"github.com/fairyhunter13/oapi-codegen/v2/examples/authenticated-api/stdhttp/api"
	"github.com/fairyhunter13/oapi-codegen/v2/examples/authenticated-api/stdhttp/server"
)
