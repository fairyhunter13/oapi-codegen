...
import (
	...
	"github.com/fairyhunter13/oapi-codegen/v2/examples/authenticated-api/echo/api"
	"github.com/fairyhunter13/oapi-codegen/v2/examples/authenticated-api/echo/server"
